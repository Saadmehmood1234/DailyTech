...
export default function NavbarClient({ categories }: Props) {
  ...
  return (
    <nav className="glass-nav relative z-50 w-full border-b border-border">
      <div className="mx-auto max-w-7xl px-6 2xl:px-0 flex justify-between lg:justify-start items-center py-4">
        ...
        <div className="max-sm:ml-2 ml-6 flex relative max-w-96 w-full">
          ...
          {suggestions.length > 0 && (
            <div className="absolute top-full mt-2 w-full bg-background border rounded-md shadow-lg z-9999">
