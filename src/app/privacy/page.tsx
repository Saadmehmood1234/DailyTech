...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-7xl mx-auto p-6 2xl:px-0">
      ...
      <p className="mb-4">
        DailyTech respects your privacy and is committed to protecting your personal information.
      </p>
      ...
      <p>
        By using DailyTech, you agree to this privacy policy. For questions, contact us at <a href="mailto:mehmoodsaad347@gmail.com" className="text-blue-600">mehmoodsaad347@gmail.com</a>.
      </p>
    </div>
  );
};
